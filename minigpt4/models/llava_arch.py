    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        for batch_idx, cur_input_ids in enumerate(input_ids):
            ...
            while image_token_indices.numel() > 0:
                cur_image_features = image_features[cur_image_idx]
                # cur_image_features.requires_grad=True #modified
                cur_image_features.requires_grad_(True)
                cur_image_features.retain_grad()
                ...
                if getattr(self.config, 'tune_mm_mlp_adapter', False) and getattr(self.config, 'mm_use_im_start_end', False):
                    ...
                    cur_new_input_embeds.append(cur_image_features)
                    # cur_new_input_embeds[0].requires_grad=True #modified
                    cur_new_input_embeds[0].requires_grad_(True)
        ...
        if any(x.shape != new_input_embeds[0].shape for x in new_input_embeds):
            ...
            # new_input_embeds.requires_grad=True #modified
